-- Re-apply confirm_assign_sets_to_users to ensure set_ref is copied to envios
...
COMMENT ON FUNCTION public.confirm_assign_sets_to_users IS 'Executes set assignments, explicitly copying set_ref to envios table';
