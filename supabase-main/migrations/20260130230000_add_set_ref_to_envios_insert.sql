-- Update confirm function to explicitly insert set_ref into envios table
...
COMMENT ON FUNCTION public.confirm_assign_sets_to_users IS 'Executes set assignments for confirmed user IDs - creates envios with set_ref, deletes from wishlist';
