...
-- ─── profiles: columns already added in 20260319000100 ───────────────────────
...
-- ─── Backfill referral codes for any profiles missing them ───────────────────
update public.profiles
set referral_code = upper(substring(md5(id::text || clock_timestamp()::text) for 7))
