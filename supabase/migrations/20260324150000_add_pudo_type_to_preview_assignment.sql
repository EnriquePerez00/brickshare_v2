-- Add pudo_type to preview_assign_sets_to_users function
...
'Generates a preview of set assignments for eligible users. Includes pudo_type to determine if Correos preregistration should be executed.';