-- Fix confirm_assign_sets_to_users function to remove orders table dependency
-- and rename envio_id to shipment_id to match frontend expectations

-- Drop the existing function
DROP FUNCTION IF EXISTS public.confirm_assign_sets_to_users(uuid[]);

-- Recreate the function with corrected return structure
...
'Confirms set assignments to users. Fixed to remove orders table dependency and return shipment_id instead of envio_id/order_id.';