...
-- \restrict amqeWlkVckvChRqU5CkOHa7CQEJZ1Q63LUUbvvbKlmVFWwzjk5V3T3zPG9fETQa
...
--
-- Data for Name: brickman_knowledge; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
INSERT INTO "public"."brickshare_pudo_locations" ("id", "name", "address", "city", "postal_code", "province", "latitude", "longitude", "contact_phone", "contact_email", "opening_hours", "is_active", "notes", "created_at", "updated_at") VALUES
	('BS-PUDO-001', 'Brickshare Madrid Centro', 'Calle Gran Vía 28', 'Madrid', '28013', 'Madrid', 40.42000000, -3.70380000, NULL, 'madrid.centro@brickshare.com', NULL, true, NULL, '2026-03-24 22:47:25.359871+00', '2026-03-24 22:47:25.359871+00'),
	('BS-PUDO-002', 'Brickshare Barcelona Eixample', 'Passeig de Gràcia 100', 'Barcelona', '08008', 'Barcelona', 41.39260000, 2.16400000, NULL, 'barcelona.eixample@brickshare.com', NULL, true, NULL, '2026-03-24 22:47:25.359871+00', '2026-03-24 22:47:25.359871+00');
...
--
-- Name: brickman_knowledge_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('"public"."brickman_knowledge_id_seq"', 1, false);
...
-- \unrestrict amqeWlkVckvChRqU5CkOHa7CQEJZ1Q63LUUbvvbKlmVFWwzjk5V3T3zPG9fETQa
