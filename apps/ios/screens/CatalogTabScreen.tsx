    ...
    <View style={styles.container}>
      ...
      {isLoading ? (
        ...
        <FlatList
          ...
          ListEmptyComponent={<Text style={styles.empty}>No hay sets en el catálogo.</Text>}
        />
      )}
    </View>
  );
...
const styles = StyleSheet.create({
  ...
  header: { paddingTop: 56, paddingHorizontal: 16, paddingBottom: 16, backgroundColor: '#fff', borderBottomWidth: 1, borderBottomColor: '#eee' },
  title: { fontSize: 24, fontWeight: '700', color: '#111' },
  centered: { flex: 1, justifyContent: 'center', alignItems: 'center', padding: 24 },
  error: { color: '#b91c1c', textAlign: 'center' },
  list: { padding: 16, paddingBottom: 32 },
  card: { backgroundColor: '#fff', borderRadius: 8, marginBottom: 12, overflow: 'hidden', borderWidth: 1, borderColor: '#eee' },
  ...
  wishlistBtn: { marginTop: 12, paddingVertical: 8, paddingHorizontal: 12, alignSelf: 'flex-start', borderRadius: 6, borderWidth: 1, borderColor: '#0f766e' },
